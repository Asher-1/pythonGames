...
METADATA = {
    ...
    'version':          '0.0.8',
    'license':          'GPL',
    'description':      'Our pyweek sept 2011 entry',
    'author':           'daspork tactii',
    'author_email':     'chris.statzer@gmail.com, tactii@gmail.com',
    'url':              'http://code.google.com/p/tartley/',
    'classifiers':      [
            'Development Status :: 4 - Beta',
            'Intended Audience :: Happy Funtime People',
            'License :: OSI Approved :: New BSD License',
            'Operating System :: OS Independent',
            'Programming Language :: Python :: 2.7',
            'Topic :: Software Development :: Libraries :: pyglet',
            'Topic :: Games/Entertainment :: Puzzle, Strategy',
    ],


    'py2exe.target':'',
    'py2exe.icon':'icon.png', #64x64
...
PACKAGEDATA = {
    ...
    'package_dir': {'tartley': 'tartley',
                   },
    'packages': ['tartley',
                ],
    'scripts': ['scripts/tartley'],
}
...
_DATA_DIR = os.path.join('tartley', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'tartley': data_dirs}
