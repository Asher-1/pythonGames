...
MUSIC = ['The F**ked Up Beat']
BUILT_USING = 'pygame'
GAME_ENGINE = 'serge'
FONTS = ['Technofont', 'American Dream', 'Deutsch Gothic']
...
class CreditsScreen(serge.blocks.actors.ScreenActor):
    ...
    def addedToWorld(self, world):
        ...
        serge.blocks.utils.addTextItemsToWorld(world, [
                    ...
                    ('Cut scene art', 'cut-scene-art'),
                    ('Jonas de Ro', 'cut-scene-art-name'),
                    ('Sound', 'sound-title1'),
                    ...
                    ('Back', 'back', serge.blocks.utils.backToPreviousWorld('back-click')),
                ],
