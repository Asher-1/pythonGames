...
class SchemaNotMet(Exception): """An object schema was not met"""
...
class Tiled(TileMap):
    ...
    def getObjectLayersByType(self, type_name):
...
class Layer(serge.common.Loggable):
    ...
    def validateSchemas(self, schema, strict_mode=False):
...
class TileObject(serge.geometry.Rectangle, serge.common.Loggable):
    ...
    def getStringTuple(self, attribute_name, default):
