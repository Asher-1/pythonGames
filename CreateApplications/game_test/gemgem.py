...
def main():
    ...
    for i in range(1, NUMGEMIMAGES+1):
        gemImage = pygame.image.load(DIR + 'gem%s.png' % i)
    ...
    # Load the sounds.
    GAMESOUNDS = {}
    GAMESOUNDS['bad swap'] = pygame.mixer.Sound(DIR + 'badswap.wav')
    GAMESOUNDS['match'] = []
    for i in range(NUMMATCHSOUNDS):
        GAMESOUNDS['match'].append(pygame.mixer.Sound(DIR + 'match%s.wav' % i))
