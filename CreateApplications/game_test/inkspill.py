...
def main():
    ...
    # Load images
    LOGOIMAGE = pygame.image.load(DIR + 'inkspilllogo.png')
    SPOTIMAGE = pygame.image.load(DIR + 'inkspillspot.png')
    SETTINGSIMAGE = pygame.image.load(DIR + 'inkspillsettings.png')
    SETTINGSBUTTONIMAGE = pygame.image.load(DIR + 'inkspillsettingsbutton.png')
    RESETBUTTONIMAGE = pygame.image.load(DIR + 'inkspillresetbutton.png')
