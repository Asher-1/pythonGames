...
class Brush(object):
    def __init__(self, screen):
        ...
        self.brush = pygame.image.load(DIR + "brush.png").convert_alpha()
...
class Menu(object):
    def __init__(self, screen):
        ...
        self.pens = [
            pygame.image.load(DIR + "pen1.png").convert_alpha(),
            pygame.image.load(DIR + "pen2.png").convert_alpha()
        ]
        self.pens_rect = []
        ...
        self.sizes = [
            pygame.image.load(DIR + "big.png").convert_alpha(),
            pygame.image.load(DIR + "small.png").convert_alpha()
        ]
        self.sizes_rect = []
