...
class BuildExe:
    def __init__(self):
        ...
        # ------------------------------------------------------#
        self.name = "Alchemic Archer"

        # 起始py文件
        self.script = u"Alchemic Archer.pyw"
        # 游戏名
        ...
        # 游戏作者
        self.author_name = "Asher"
        # 联系电邮
        self.author_email = "ludahai19@163.com"
        # 游戏版权
        self.copyright = "Copyright (c) 3000 Asher."
        # 游戏描述
        self.project_description = self.name + " Description"
