...
script = {
    ...
    "End": [
        ...
        ("End.png",
         ("After Radkelu's evil power over Kiripan had been dispelled,", "Kiripan returned to the ground safely...",
          "and Ardentryst was saved from the clutches of despair!"),
         None,
         None,
         (1, 25, 0, 2),
         None
...
class Game_Object:
    ...
    def story_scene(self, scene, screen, d, f, s):
        ...
        while Showing:
            ...
            if not CUT:
                fade_screens(screen, this_slide, 25)
            else:
                screen.blit(this_slide, (0, 0))
