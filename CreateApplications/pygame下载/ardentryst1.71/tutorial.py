...
class TutBox:
    def __init__(self, controls):
        ...
        self.Checkpoints = [
            ...
            (900,
             ["Carefully jump over this chasm.",
              "#Use " + key("Up") + " to jump. Hold this key down while you are running for the best results!"]),
            (1300,
             "#This is a monster. To attack, press " + key(
                 "B-1") + ". This is your Attack 1 button. Go up to it now, and keep attacking it!"),
            (2000,
             "#To do advanced attacks, you'll need to input more buttons. After using " + key(
                 "B-1") + " which is your Attack 1 button,"
                          " use " + key(
                 "B-2") + ". If you time it right, you'll joust with your weapon. Do this whilst running for best results!"),
            (2300,
            ...
            (2865,
             "#Since this name is shown, you can activate this object. Press " + key(
                 "B-3") + " to open it! Check the top of the screen to see"
                          " what you got."),
            (2900,
            ...
            (3000,
             "#Using magic is a valid way of getting enemies out of your way. Pressing your Attack 4 button, " + key(
                 "B-4") + ", you will"
                          " focus your thoughts. This is how any magical spell starts. Try pressing " + key(
                 "B-4") + " now, after this box."),
            (3250,
             "#When the aura is visible, if you press Button 5, " + key(
                 "B-5") + ", you will unleash your basic magic (Fire)"
                          " attack. Use up/down to make it wave! This will consume mana (see the blue bar in the bottom right!)$490,410$&"),
            (3600,
             "Defeat this next monster with fire. Remember, press " + key("B-4") + ", then quickly " + key(
                 "B-5") + "!"),
            (4500,
        ...
        self.Checkpoints2 = [
            ...
            (1385,
             ["Ooh, a potion! Let's drink it.",
              "#Bring up the in-game menu with " + key("B-9") + " and drink the potion if you got it. You can also"
                                                                " use this menu from outside of levels!"
              ]),
            (1490,
             "Oh dear, the Arexes have made a new home out of our hallways. You will have to dispose of them... Either attack them with " + key(
                 "B-1") + " or"
                          " use some of your icy magic by pressing " + key("B-4") + ", " + key(
                 "B-5") + "! You might like to"
                          " see what abilities you have. You can find out from the menu (press " + key("B-9") + ".)*2"),
            (1550,
             "#When the aura is visible, if you press Button 5, " + key(
                 "B-5") + ", you will unleash your basic magic (ice)"
                          " attack. This will consume mana (see the blue bar in the bottom right!)$490,410$&"),
            (2865,
             "Alright, that was good. Now keep on the lookout for bits of the castle ceiling that might give way. To look up, hold " + key(
                 "B-8") + " and"
                          " then use " + key("Up") + ".")
        ]
